<template>
	<div class="navbar">
		<div class="title" :style='{"margin":"0px","top":"20px","textAlign":"left","left":"-180px","background":"none","display":"block","width":"150px","position":"absolute","order":"3"}'>
			...
			<span class="title-name" :style='{"padding":"0px","lineHeight":"1.5","fontSize":"16px","color":"#fff","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"fontSize":"inherit","position":"absolute","right":"30px","color":"inherit","display":"inline-block","zIndex":"9999"}'>
